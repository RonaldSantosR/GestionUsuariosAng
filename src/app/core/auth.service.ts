...
export class AuthService {
  ...
  attemptAuth(ussername: string, password: string): Observable<any> {
    ...
    return this.http.post<any>('http://192.168.1.212:8082/login/token', null, {headers: this.headers});
  }
  ...
  FinAuth(): Observable<any> {
    ...
    return this.http.post<any>('http://192.168.1.212:8082/login/cerrarsession', sesion);
